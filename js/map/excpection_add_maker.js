...
function excpectionAdd() {
    ...
    var obj = {
        ...
        time: timeSel[0].value + '-' + timeSel[1].value + '-' + timeSel[2].value + ' ' + timeSel[3].value + ':' + timeSel[4].value
    }
...
function addMarkerWarm(data) {
    ...
    var myIcon = new BMap.Icon("../images/unusual-point.png", new BMap.Size(45, 76));
...
function openInfo(headTit, content, e) {
    ...
    var point = new BMap.Point(bsne.lng, bssw.lat);
